...
- (StreamViewCell *)tableView:(UITableView *)tableView cellForRowAtIndexPath:(NSIndexPath *)indexPath object:(PFObject *)object {
    ...
    // Configure the cell
    cell.poster.text = [object objectForKey:@"text"];
    return cell;
}
